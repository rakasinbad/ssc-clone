...
export class FuseNavigationService {
     ...
     * @returns {any | boolean}
     */
    getNavigationItem(id, navigation = null, key?: string): any | boolean {
        if (!navigation) {
            if (!key) {
     ...
     * @param properties
     */
    updateNavigationItem(id, properties, key?: string): void {
        // Get the navigation item
        const navigationItem = this.getNavigationItem(id, null, key);
