...
import { CatalogueSegmentation as Entity } from './models';
import { CatalogueSegmentationApiService as EntitiesApiService, SingleCatalogueSegmentationService } from './services';
...
export class CatalogueSegmentationComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private singleCatalogueSegmentation: SingleCatalogueSegmentationService,
    ) {
    ...
    ngOnInit(): void {
        ...
        this.singleCatalogueSegmentation.getSelectedCatalogueSegment().pipe(
    ...
    ngOnDestroy(): void {
        ...
        this.singleCatalogueSegmentation.selectCatalogueSegment(null);
