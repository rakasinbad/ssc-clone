...
import { StoreSegmentationChannel as Entity } from './models';
import { StoreSegmentationChannelsApiService as EntitiesApiService } from './services';
...
@Component({
    selector: 'select-store-segmentation-channels',
    templateUrl: './store-segmentation-channels.component.html',
    styleUrls: ['./store-segmentation-channels.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.Default
})
export class StoreSegmentationChannelsDropdownComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    @ViewChild('selectStoreChannel', { static: false }) selectStoreChannel: TemplateRef<MultipleSelectionComponent>;
...
// 
    ...
    openStoreChannelSelection(): void {
