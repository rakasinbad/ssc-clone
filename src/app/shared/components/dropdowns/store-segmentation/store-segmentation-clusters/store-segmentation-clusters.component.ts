import { Component, OnInit, ViewEncapsulation, ChangeDetectionStrategy, Input, ViewChild, AfterViewInit, OnDestroy, EventEmitter, Output, ChangeDetectorRef, TemplateRef } from '@angular/core';
...
import { StoreSegmentationCluster as Entity } from './models';
import { StoreSegmentationClustersApiService as EntitiesApiService } from './services';
...
@Component({
    ...
    templateUrl: './store-segmentation-clusters.component.html',
    styleUrls: ['./store-segmentation-clusters.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.Default
})
export class StoreSegmentationClustersDropdownComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    @ViewChild('selectStoreCluster', { static: false }) selectStoreCluster: TemplateRef<MultipleSelectionComponent>;
...
// 
    ...
    openStoreClusterSelection(): void {
