...
export interface SegmentChannelResponse {
...
export class SegmentChannelAutocomplete implements SinbadAutocompleteSource {
    readonly id: NonNullable<string>;
    label: string;
    originalSource: SegmentChannelResponse;
