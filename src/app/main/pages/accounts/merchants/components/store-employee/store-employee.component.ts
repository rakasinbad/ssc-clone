import { Component, OnInit, ViewEncapsulation, ViewChild, AfterViewInit, OnDestroy, Input, OnChanges } from '@angular/core';
...
export class StoreEmployeeComponent implements OnInit, AfterViewInit, OnDestroy, OnChanges {
