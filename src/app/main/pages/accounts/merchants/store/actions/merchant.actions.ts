...
export const checkStoreExternalIdRequest = createAction(
    '[Helper Search] Check Store External ID Request',
    props<{ externalId: string }>()
);

export const checkStoreExternalIdSuccess = createAction(
    '[Helper Search] Check Store External ID Success'
);

export const checkStoreExternalIdFailure = createAction(
    '[Helper Search] Check Store External ID Failure',
    props<{ payload: IErrorHandler }>()
);
