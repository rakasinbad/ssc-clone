...
import { MerchantFilterDto } from './models';
...
export class MerchantsComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    globalFilterDto: MerchantFilterDto;

    isPendingOrUpdatingTab: boolean = false;
    ...
    @ViewChild('cardHeader', { static: true }) cardHeader: CardHeaderComponent;
    ...
    onRejectStore(item: SupplierStore): void {
        ...
        const canChangeStatusStore = this.ngxPermissions.hasPermission('ACCOUNT.STORE.VERIFY');
    ...
    private _updateHeadCheckbox(): void {
        if (this.headCheckbox) {
            ...
            const totalSelectedOnPage = dataSourceIds.filter((id) =>
    ...
    private _updateDisplayedColumns(hasUpdateAccess: boolean): void {
        if (hasUpdateAccess) {
            ...
            if (this.isPendingOrUpdatingTab === true) {
                this.displayedColumns.push('store-data');
            }
    ...
    private _handleApplyFilter(): void {
        ...
        const { storeData } = this.form.value;
    ...
    private _initPage(lifeCycle?: LifecyclePlatform): void {
        switch (lifeCycle) {
            ...
            default:
                ...
                this.isPendingOrUpdatingTab = false;
                ...
                this.sinbadFilterService
                    ...
                    .subscribe((action) => {
                        ...
                        HelperService.debug('[MerchantComponent] ngOnInit getClickAction$()', {
                            form: this.form,
                            filterConfig: this.filterConfig,
                            globalFilter: this.globalFilterDto
                        });
                    });
                            ...
                            if (typeof limit !== 'undefined' && typeof pageIndex !== 'undefined') {
                                ...
                                switch (status) {
                                    ...
                                    case 'pending':
                                        ...
                                        this.isPendingOrUpdatingTab = true;
                                        this.cardHeaderConfig = {
                                            ...this.cardHeaderConfig,
                                            filter: { permissions: [] },
                                        };
    ...
    private _initTable(): void {
        localStorage.removeItem('ssc-store-detail');
        ...
        if (this.globalFilterDto) {
            if (this.globalFilterDto.storeData) {
                data['storeData'] = this.globalFilterDto.storeData;
            }
        }
