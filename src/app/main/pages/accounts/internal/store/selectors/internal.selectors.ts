...
export const getSelectedInternalRegionIds = createSelector(
    getInternalEmployeeState,
    state => state.internalWarehouses.regionIds
);

export const getSelectedInternalBranchIds = createSelector(
    getInternalEmployeeState,
    state => state.internalWarehouses.branchIds
);

export const getSelectedInternalWarehouses = createSelector(
    getInternalEmployeeState,
    state => state.internalWarehouses.warehouses
);

export const getSelectedInternalWarehouseLabel = createSelector(
    getInternalEmployeeState,
    state => ({
        firstSelected: state.internalWarehouses.firstWarehouseName,
        total: state.internalWarehouses.totalWarehouse
    })
);
