...
// -----------------------------------------------------------------------------------------------------
// Fetch Internal Selected Warehouses
// -----------------------------------------------------------------------------------------------------

export const fetchInternalWarehousesRequest = createAction(
    '[Internal Warehouses API] Fetch Internal Warehouses Request',
    props<{ payload: string }>()
);

export const fetchInternalWarehousesSuccess = createAction(
    '[Internal Employee API] Fetch Internal Warehouses Success',
    props<{ payload: InternalWarehouses }>()
);

export const fetchInternalWarehousesFailure = createAction(
    '[Internal Warehouses API] Fetch Internal Warehouses Failure',
    props<{ payload: IErrorHandler }>()
);
