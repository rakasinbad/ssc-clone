...
import { IInternalEmployeeDetails, IInternalWarehouses, InternalEmployeeDetail } from '../models';
...
export class InternalApiService {
    ...
    private readonly _endpointSelectedWarehouses = '/user-regions';
    ...
    findSelectedWarehousesById(userId: string): Observable<IInternalWarehouses> {
        this._url = this._$helper.handleApiRouter(this._endpointSelectedWarehouses);
        return this.http.get<IInternalWarehouses>(`${this._url}?userId=${userId}`);
    }
}
