...
export class SkuAssignmentFormComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    availableCatalogues$: Observable<Array<any>>;
    ...
    constructor(
        ...
        this.totalCatalogues$ = new Observable(observer => observer.next(100));
        ...
        this.isCatalogueLoading$ = new Observable(observer => observer.next(false));
