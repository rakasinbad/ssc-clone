...
enum Actions {
    ...
    UpdateStatusFailure = '[Catalogue Segmentation] Update Status Failure',
    UpdateStatusRequest = '[Catalogue Segmentation] Update Status Request',
    UpdateStatusSuccess = '[Catalogue Segmentation] Update Status Success',
...
// export const updateStatusRequest = createAction(Actions.UpdateStatusRequest, props<{}>())
