...
@Component({
    ...
    templateUrl: './period-target-promo.component.html',
    styleUrls: ['./period-target-promo.component.scss'],
    animations: fuseAnimations
})
export class PeriodTargetPromoComponent implements OnInit, OnDestroy {
