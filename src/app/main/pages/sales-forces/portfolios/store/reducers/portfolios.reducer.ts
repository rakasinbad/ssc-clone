...
export const reducer = createReducer(
    ...
    on(PortfolioActions.exportPortfoliosSuccess, (state, { payload }) => ({
        ...state,
        isLoading: false,
        urlExport: payload
    })),
    on(PortfolioActions.createPortfolioFailure, state => ({
        ...state,
        isLoading: false
    })),
    on(PortfolioActions.patchPortfolioFailure, state => ({
        ...state,
        isLoading: false
    })),
    on(PortfolioActions.createPortfolioSuccess, state => ({
        ...state,
        isLoading: false
    })),
    on(PortfolioActions.patchPortfolioSuccess, state => ({
        ...state,
        isLoading: false
    })),
    ...
    on(PortfolioActions.fetchPortfolioStoresRequest, state => ({
        ...state,
        stores: {
            ...state.stores,
            isLoading: true
    ...
    on(PortfolioActions.setSelectedInvoiceGroupId, (state, { payload }) => ({
        ...state,
    ...
    on(PortfolioActions.setSearchKeywordPortfolio, (state, { payload }) => ({
        ...state,
        search: payload
    })),
    on(PortfolioActions.resetSearchKeywordPortfolio, state => ({
        ...state,
        search: null
    })),
    on(PortfolioActions.addSelectedStores, (state, { payload }) => {
    ...
    on(PortfolioActions.removeSelectedStores, (state, { payload }) => ({
        ...state,
        newStores: adapterPortfolioNewStore.removeMany(payload, {
            ...state.newStores
        })
    })),
    on(PortfolioActions.addSelectedPortfolios, (state, { payload }) => {
    ...
    on(PortfolioActions.markStoreAsRemovedFromPortfolio, (state, { payload }) => {
    ...
    on(PortfolioActions.markStoresAsRemovedFromPortfolio, (state, { payload }) => {
    ...
    on(PortfolioActions.abortStoreAsRemovedFromPortfolio, (state, { payload }) => {
        const newStore = new Store(state.stores.entities[payload]);
    ...
    on(PortfolioActions.abortStoresAsRemovedFromPortfolio, (state, { payload }) => {
        const newStore: Array<Store> = [];
    ...
    on(PortfolioActions.setSelectedPortfolios, (state, { payload }) => ({
        ...state,
        selectedIds: payload
    })),
    on(PortfolioActions.truncateSelectedPortfolios, state => ({
        ...state,
        selectedIds: []
    })),
    on(PortfolioActions.truncatePortfolioStores, state => ({
        ...state,
    ...
    on(PortfolioActions.truncatePortfolios, state => adapter.removeAll(state)),
    on(PortfolioActions.updateStore, (state, { payload }) => ({
        ...state,
